...
describe('search', function() {
  ...
  beforeEach(async function() {
    driverSearch = await new webdriver.Builder().forBrowser(browser).build()
  ...
  it('search de icd code (A15.3)', async function() {
    await driverSearch.get("http://localhost:3000/de/ICD/ICD10-GM-2022/icd_chapters/ICD10-GM-2022")
    await sleep(2*n);
  ...
  it('search it icd (letters)', async function() {
    await driverSearch.get("http://localhost:3000/it/ICD/ICD10-GM-2020/icd_chapters/ICD10-GM-2020")
    await sleep(2*n);
    await driverSearch.wait(until.elementLocated(By.css(".me-2"))).click()
    await sleep(n);
  ...
  it('search en icd (letters)', async function() {
    await driverSearch.get("http://localhost:3000/en/ICD/ICD10-GM-2022/icd_chapters/ICD10-GM-2022")
    await sleep(2*n);
    await driverSearch.wait(until.elementLocated(By.css(".me-2"))).click()
    await sleep(n);
    await driverSearch.wait(until.elementLocated(By.css(".me-2"))).sendKeys("letters")
  ...
  it('search fr icd (letters)', async function() {
    await driverSearch.get("http://localhost:3000/fr/ICD/ICD10-GM-2020/icd_chapters/ICD10-GM-2020")
    await sleep(2*n);
    await driverSearch.wait(until.elementLocated(By.css(".me-2"))).click()
    await sleep(n);
    await driverSearch.wait(until.elementLocated(By.css(".me-2"))).sendKeys("letters")
