 ...
 * */
function SupplementsAttributes({ attributes }: Props) {
    ...
    function renderClickableCodesArray(codes, catalog, codesType) {
    ...
    function renderCodesArray(codes, title, codeType, id) {
        return (
            <div id={id}>
    ...
    function dosageInfo(attrs) {
        return (
            <>
                <tr>
                    <td><b>{t('LBL_DOSE_MIN')}</b></td>
                    <td>{attrs.dose_min + attrs.dose_unit}</td>
                </tr>
                {attrs.dose_max > 0 &&
                    <tr>
                        <td><b>{t('LBL_DOSE_MAX')}</b></td>
                        <td>{attrs.dose_max + attrs.dose_unit}</td>
                    </tr>}
            </>
        )
    }
